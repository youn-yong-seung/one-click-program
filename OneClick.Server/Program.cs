...
builder.Services.AddScoped<OneClick.Server.Services.AutomationService>();
builder.Services.AddScoped<OneClick.Server.Services.Automation.IAutomationModule, OneClick.Server.Services.Automation.Modules.KakaoAutomation>();
// Future: builder.Services.AddScoped<IAutomationModule, InstaAutomation>();
...
app.UseStaticFiles(); // Enable serving updates
